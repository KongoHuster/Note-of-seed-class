...
int main (int argc, char *argv[])
{
  ...
  Config::SetDefault ("ns3::WifiRemoteStationManager::MaxSsrc", UintegerValue (10000)); //RTS/CTS模式的重传次数
  Config::SetDefault ("ns3::WifiRemoteStationManager::MaxSlrc", UintegerValue (10000)); //基本接入模式的重传次数
